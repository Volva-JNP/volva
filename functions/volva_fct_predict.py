...
def build_page_predict():
    ...
    if menu_secteur!="vide" and menu_secteur!="secteur frais":
        ...
        elif menu_secteur =='secteur frais': 
            placeholder = st.empty()
            placeholder.warning("Les modèles ne sont pas assez performants sur le secteur frais pour permettre des prévisions ...")
